...
function Get-PackageFiles {
    @('00-settings.cmd','01-install.cmd','02-refresh-index.cmd','03-change-now.cmd','04-stop-and-restore.cmd','05-show-monitors.cmd',
      'Config.ps1','ImageProcessing.ps1','Rendering.ps1','Transition.ps1','Preview.ps1','Language.ps1','Lifecycle.ps1','Uninstall.ps1',
      'UpdateCore.ps1','UpdateWorker.ps1','UpdateApply.ps1','UpdateUI.ps1','Test-Updates.ps1',
